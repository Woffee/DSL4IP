...
(You can find the original definitions in [common.g](/lark22/grammars/common.g).)
...
```python
from lark22 import Transformer
...
```python
import sys
from lark22 import Lark, Transformer
